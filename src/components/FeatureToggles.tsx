import { PenTool, Navigation, Volume2, VolumeX, Mic, MicOff, Smartphone, Eye, EyeOff, Smile, Cable, Ruler } from "lucide-react";
...
const TOGGLES: {
  ...
  { key: "measuring", label: "Measure", iconOn: Ruler, iconOff: Ruler, group: "features" },
